...
const styles = StyleSheet.create({
  ...
  rowDragging: { borderColor: '#FF6B2C', backgroundColor: '#15140f' },
  ...
  numText: { color: '#FF6B2C', fontSize: 11, fontWeight: '700' },
  handle: {
    width: 30, height: 30, borderRadius: 6,
    borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)',
    alignItems: 'center', justifyContent: 'center',
  },
  handleText: { color: '#F5F2EC', fontSize: 16, lineHeight: 18 },
  name: { color: '#F5F2EC', fontSize: 12, flex: 1 },
  ...
  fill: { height: 4, backgroundColor: '#FF6B2C' },
  ...
  playActive: { borderColor: '#FF6B2C', backgroundColor: 'rgba(255,107,44,0.12)' },
  btnText: { color: '#F5F2EC', fontSize: 12 },
  danger: { color: '#ff8080' },
